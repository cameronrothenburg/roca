...
use std::path::Path;
use roca_ast::*;
use roca_check::walker::type_ref_to_name;
...
pub fn run_search(query: &str) {
    ...
    let stdlib = roca_parse::parse(STDLIB_SOURCE);
